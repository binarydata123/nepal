...
<head>
   ...
   <link rel="icon" href="<?php echo e(url('public/media/faviconImg', $setting_data->favicon)); ?>">
   <?php else: ?>
   <link rel="icon" href="<?php echo e(url('public/images/users/dealmih.png')); ?>">
   <?php endif; ?>
   <?php
   $uri = $_SERVER['REQUEST_URI'];
   ...
   <link rel="stylesheet" href="<?php echo e(url('public/website/fonts/flaticon/flaticon.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/fonts/font-awesome/fontawesome.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/vendor/slick.min.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/vendor/bootstrap.min.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/main.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/index.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/user-form.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/dashboard.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/ad-details.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/blog-details.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/vendor/emojionearea.min.css')); ?>">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/custom/rangeSlider.css')); ?>">
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
   <link rel="stylesheet" href="<?php echo e(url('public/website/css/notifications/Lobibox.min.css')); ?>">
         ...
         <div class="header-content">
            <div class="header-left">
               ...
               <a href="<?php echo e(url('/')); ?>" class="header-logo">
                  ...
                  <img src="<?php echo e(url('public/media/websitelogo', $setting_data->site_logo)); ?>" class="po" alt="logo">
                  <?php else: ?>
                  <img src="<?php echo e(url('public/website/images/logo.png')); ?>" class="po" alt="logo">
                  <?php endif; ?>
               </a>
 ...
 -->
   ...
   <aside class="sidebar-part">
      <div class="sidebar-body">
         <div class="sidebar-header"><a href="<?php echo e(url('/')); ?>" class="sidebar-logo"><img src="<?php echo e(url('public/website/images/logo.png')); ?>" alt="logo"></a><button class="sidebar-cross"><i class="fas fa-times"></i></button></div>
         ...
         <div class="modal-content">
            ...
            <div class="modal-body" align="center">
               ...
               <ul class="user-form-option">
                  <li><a href="<?php echo e(url('auth/google')); ?>"><img src="<?php echo e(url('public/website/images/ui.svg')); ?>"><span> Sign in With Google</span></a></li>
   ...
   </script><?php /**PATH /opt/lampp/htdocs/newdeal/newdealmih/resources/views/website/layout/app.blade.php ENDPATH**/ ?>